...
// NOTA: Este archivo fue generado con una versión antigua de sails-client-gen
// y necesita ser regenerado. Mientras tanto, esta implementación está comentada.
// Para regenerar: ejecuta sails-client-gen con la versión correcta de sails-rs
/*
...
pub mod extended_vnft_factory {
    ...
    pub mod io {
        use super::*;
        // NOTA: Esta implementación requiere ActionIo que no está disponible
        // Regenera el cliente con sails-client-gen para obtener la implementación correcta
        pub struct New(());
        /*
        impl New {
            #[allow(dead_code)]
...
// NOTA: Esta implementación completa está comentada porque requiere tipos que no están disponibles
// IMPORTANTE: Regenera este archivo con sails-client-gen usando la versión correcta de sails-rs
// Para regenerar: ejecuta `sails-client-gen` en el directorio wasm con el IDL correcto
/*
...
pub mod vnft {
    ...
    // NOTA: Todo el módulo io está comentado porque requiere ActionIo que no está disponible
    // Regenera el cliente con sails-client-gen para obtener la implementación correcta
    /*
    pub mod io {
        use super::*;
        ...
        pub struct Burn(());
        // NOTA: ActionIo no está disponible - regenera el cliente
        /*
        impl Burn {
            #[allow(dead_code)]
    ...
    */
    ...
    // NOTA: El módulo events también está comentado porque requiere EventIo que no está disponible
    /*
    #[allow(dead_code)]
...
// TokenMetadata se mantiene porque se usa en otros lugares
